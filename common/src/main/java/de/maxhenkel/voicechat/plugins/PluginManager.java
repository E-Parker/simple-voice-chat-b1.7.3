...
public class PluginManager {
    ...
    public boolean onJoinGroup(PlayerEntity player, @Nullable Group group) {
        if (group == null) {
    ...
    public boolean onCreateGroup(@Nullable PlayerEntity player, @Nullable Group group) {
        if (group == null) {
            if (player == null) {
                return false;
            }
    ...
    public boolean onLeaveGroup(PlayerEntity player) {
    ...
    public boolean onMicPacket(PlayerEntity player, PlayerState state, MicPacket packet) {
        return dispatchEvent(MicrophonePacketEvent.class, new MicrophonePacketEventImpl(
                new MicrophonePacketImpl(packet, ((PlayerEntityExtension) player).getUniqueID()),
                new VoicechatConnectionImpl(player, state)
        ));
    }

    public boolean onSoundPacket(@Nullable PlayerEntity sender, @Nullable PlayerState senderState, PlayerEntity receiver, PlayerState receiverState, SoundPacket<?> p, String source) {
